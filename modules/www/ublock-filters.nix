...
in {
  iliana.www.virtualHosts."buttslol.net"."/ublock-filters.txt" = helpers.caddy.serve (pkgs.writeTextDir "ublock-filters.txt" ''
    ...
    ! This list isn't meant for public use as-is; at some point I'll get annoyed at something you like.
    ! But feel free to copy anything interesting you like into your own filter rules.
